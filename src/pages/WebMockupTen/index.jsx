...
const WebMockupTenPage = () => {
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-poppins mx-[auto] relative w-[100%]">
        <div className="flex items-center justify-start m-[auto] w-[100%]">
          <div className="bg-bluegray_900 h-[1200px] w-[100%]"></div>
        </div>
        <div className="bg-white_A700 flex items-center justify-end max-w-[1440px] mt-[-1160px] mx-[auto] md:px-[20px] w-[100%] z-[1]">
          <div className="flex flex-col items-center justify-start w-[100%]">
            <ECommerceHomePageTopheader
              className="bg-black_900 flex flex-col items-center justify-center w-[100%]"
              offer="Summer Sale For All Swim Suits And Free Express Delivery - OFF 50%!"
              shopnow="ShopNow"
              language="English"
            />
            <ECommerceHomePageHeader
              className="flex flex-row font-inter items-center justify-between mt-[40px] self-stretch md:w-[100%] w-[auto]"
              exclusive="Exclusive"
              contact="Contact"
              about="About"
              signup="Sign Up"
            ...
            <Img
              ...
              alt="lineThree"
            />
            <div className="flex md:flex-col flex-row font-poppins md:gap-[20px] items-start justify-start md:w-[100%] w-[82%]">
            ...
            <div className="flex flex-col font-poppins gap-[40px] items-start justify-start mt-[137px] overflow-auto self-stretch md:w-[100%] w-[auto]">
            ...
            <Line className="bg-black_900_75 h-[1px] mt-[60px] rotate-[-180deg] w-[82%]" />
            <div className="flex flex-col font-poppins md:gap-[40px] gap-[60px] items-start justify-start mt-[59px] self-stretch md:w-[100%] w-[auto]">
              ...
              <List
                ...
                orientation="horizontal"
              >
                <div className="hover:border-[0] border-[1px] border-black_900_4c border-solid hover:cursor-pointer flex flex-col gap-[16px] items-center justify-end hover:mx-[0] p-[24px] sm:px-[20px] rounded-[4px] hover:shadow-bs hover:w-[100%] w-[100%]">
                  <Img
                ...
                <div className="bg-red_600 hover:border-[0] border-[1px] border-black_900_4c border-solid hover:cursor-pointer flex flex-col gap-[16px] items-center justify-end hover:mx-[0] p-[24px] sm:px-[20px] rounded-[4px] hover:shadow-bs shadow-bs hover:w-[100%] w-[100%]">
                  <Img
            ...
            <Line className="bg-black_900_75 h-[1px] mt-[60px] rotate-[-180deg] w-[82%]" />
            <div className="bg-black_900 flex items-center justify-start mt-[59px] sm:px-[20px] md:px-[40px] px-[44px] md:w-[100%] w-[82%]">
              <div className="flex md:flex-col flex-row gap-[27px] items-center justify-start md:w-[100%] w-[99%]">
                <div className="flex flex-col items-start justify-start md:w-[100%] w-[42%]">
                  ...
                  <Text
                    className="font-inter font-semibold leading-[60.00px] mt-[32px] text-gray_50 text-left tracking-[1.92px] w-[100%]"
                    as="h3"
                    variant="h3"
                  >
                  ...
                  >
                    <ECommerceHomePageFlashselltimer
                      className="bg-white_A700 flex flex-col h-[62px] items-center justify-start p-[14px] rounded-[50%] w-[100%]"
                      twentythree="23"
                      hours="Hours"
                    />
            ...
            <div className="flex flex-col font-poppins md:gap-[40px] gap-[60px] items-center justify-start mt-[80px] self-stretch md:w-[100%] w-[auto]">
            ...
            <div className="flex flex-col font-poppins md:gap-[40px] gap-[60px] items-start justify-start mt-[80px] self-stretch md:w-[100%] w-[auto]">
            ...
            <div className="flex md:flex-col flex-row font-poppins md:gap-[40px] items-start justify-between ml-[auto] mt-[80px] md:w-[100%] w-[77%]">
              <ECommerceHomePageListcut
                className="sm:flex-col flex-row grid grid-cols-1 justify-center mb-[40px] self-stretch md:w-[100%] w-[auto]"
              ...
              />
              <Button className="bg-red_600 flex h-[46px] items-center justify-center md:mt-[0] mt-[155px] p-[11px] rotate-[90deg] rounded-[50%] w-[46px]">
                <Img
            ...
            <ECommerceHomePageFooter className="bg-black_900 flex flex-col font-poppins items-center justify-end mt-[40px] py-[24px] w-[100%]" />
          </div>
        </div>
      </div>
    </>
...
export default WebMockupTenPage;
