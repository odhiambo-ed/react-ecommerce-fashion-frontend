    ...
    <>
      <div className={props.className}>
        <div className="bg-gray_100 flex flex-col p-[12px] relative rounded-[4px] w-[100%]">
          ...
          <div className="flex items-center justify-start mb-[auto] mt-[-53px] mx-[auto] p-[5px] w-[71%] z-[1]">
            <Img
              src="images/img_newmercedesbe.png"
              className="h-[133px] md:h-[auto] my-[18px] object-cover w-[100%]"
              alt="newmercedesbe"
            />
          </div>
        </div>
        <div className="flex flex-col gap-[8px] items-start justify-start self-stretch w-[auto]">
          ...
          <Img
            src="images/img_camera_red_600.svg"
